...
public class PayNegativeTestsBTV {
    @Test
    void negativePayTestBTV() {
        ...
        $x("(//input[@class='input-component__input'])[1]").sendKeys("4000056655665556");
        $x("(//input[@id='date'])[1]").sendKeys("0126");
        $x("(//input[@id='cvv'])[1]").sendKeys("111");
        $x("(//button[@class='button button_primary'])[1]").click();
        $x("(//span[contains(text(),\"Недостаточно средств на карте\")])[1]").shouldHave(text("Недостаточно средств на карте"));
        ...
        $(".packages-info__container__pc__container").shouldHave(text("Попробовать бесплатно"));
    }
}